...
const VerProducto = ({ producto  })=>{
    ...
    const { _id , nombre , codigo , barras , rubro , marca , precio_venta_tarjeta , precio_venta_efectivo , precio_venta_conocidos , precio_compra_dolar , precio_compra_peso , valor_dolar_compra , fecha_compra , proveedor , disponibles , rentabilidad , modelo , notas  } = producto;
