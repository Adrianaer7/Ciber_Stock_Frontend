...
const VerProducto = ({ producto  })=>{
    ...
    const { _id , nombre , codigo , barras , rubro , marca , precio_venta_tarjeta , precio_venta_efectivo , precio_venta_conocidos , precio_compra_dolar , precio_compra_peso , valor_dolar_compra , fecha_compra , proveedor , todos_proveedores , disponibles , rentabilidad , modelo , notas  } = producto;
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0,jsx_runtime_.jsxs)("tr", {
                                    ...
                                    children: [
                                        /*#__PURE__*/ jsx_runtime_.jsx("th", {
                                            scope: "row",
                                            className: "px-6 py-4 font-medium text-gray-900 dark:text-white whitespace-nowrap text-left",
                                            children: "C\xd3DIGO DE BARRAS"
                                        }),
                                        /*#__PURE__*/ jsx_runtime_.jsx("td", {
                                            className: "px-6 py-4 text-left",
                                            children: barras ? barras : "-"
                                        })
                                    ]
                                }),
                                /*#__PURE__*/ (0,jsx_runtime_.jsxs)("tr", {
                                ...
                                /*#__PURE__*/ (0,jsx_runtime_.jsxs)("tr", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ jsx_runtime_.jsx("td", {
                                            className: "px-6 py-4 text-left",
                                            children: precio_venta_conocidos ? "$" + precio_venta_conocidos : "-"
                                        })
                                    ]
                                }),
                                /*#__PURE__*/ (0,jsx_runtime_.jsxs)("tr", {
                                ...
                                /*#__PURE__*/ (0,jsx_runtime_.jsxs)("tr", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ jsx_runtime_.jsx("td", {
                                            className: "px-6 py-4 text-left",
                                            children: todos_proveedores.length > 0 ? todos_proveedores.map((prov, i)=>/*#__PURE__*/ (0,jsx_runtime_.jsxs)("p", {
...
async function getServerSideProps({ params: { id  }  }) {
    const { data  } = await axios/* default.get */.Z.get(`/api/productos/${id}`);
