...
const ListadoProveedores = () => {
    ...
    const onChangeFiltro = e => {
        ...
        proveedoresFiltrados(e.target.value.toUpperCase().trim().normalize("NFD").replace(/[\u0300-\u036f]/g, ""))
    }
            ...
            {crearNuevo ? (
                <div className="py-3">
                    ...
                    >
                        ...
                        <button
                            className="bg-blue-700 text-white px-2 rounded-lg font-bold uppercase"
                        >
                            Guardar
                        </button>
                        </div>
