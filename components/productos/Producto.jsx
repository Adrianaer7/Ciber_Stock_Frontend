...
const Producto = ({producto}) => {
    ...
    return (
        <tr className="border-b dark:border-b-gray-800 dark:last:border-none  hover:bg-gray-50 hover:cursor-pointer active:bg-gray-100 dark:active:bg-gray-800 dark:hover:bg-gray-700">
            ...
            <td className="p-3 dark:text-gray-50 text-center">{todasGarantias.map((garantia, i) => (<div key={i}><p className="font-medium ">{garantia.caducidad}</p><p className="mb-1">{garantia.proveedor}</p></div>))}</td>
